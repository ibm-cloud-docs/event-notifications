...
![{{site.data.keyword.en_short}} flow](images/en-relationship-model.svg "{{site.data.keyword.en_short}} flow"){: caption="Figure 1. {{site.data.keyword.en_short}} relationship model" caption-side="bottom"}
