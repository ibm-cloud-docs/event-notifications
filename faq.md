...
- FCM or Android devices:
   ...
   For more information, see [FCM error response codes for downstream messages](https://firebase.google.com/docs/cloud-messaging/server-environment#error-codes){: external}.
