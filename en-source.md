...
keywords: event-notifications, event notifications sources
...
To add an {{site.data.keyword.cloud_notm}} source or an API source, see [Add an {{site.data.keyword.en_short}} source tutorial](/docs/event-notifications?topic=event-notifications-en-add-source).

## {{site.data.keyword.cloud_notm}} platform sources
{: #en-ibm-cloud-platform-sources}

{{site.data.keyword.cloud_notm}} platform sources are built-in sources that provide events from core {{site.data.keyword.cloud_notm}} platform services.
