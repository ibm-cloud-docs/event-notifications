...
In the example, 
the total SMS units for messages that are sent to destination numbers in the United States is:
3 x 5 x 0.61 = 9.15 SMS units

and
the total SMS price for messages that are sent to destination numbers in the United States is:
3 x 5 x 0.0098515 = 0.1477725 Dollars
