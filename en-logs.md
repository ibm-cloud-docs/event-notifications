...
| `event-notifications.00021I` | `INFO` | `An email of size 1048 bytes is sent to the following recepients: <masked-email-id>, from the sender: <masked-sender-email-id>`|
| `event-notifications.00022I` | `INFO` | `An email of size 1048 bytes is deferred to each of the following : <masked-email-id>, from the sender: <masked-sender-email-id>`|
