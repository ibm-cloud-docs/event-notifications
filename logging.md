...
If you want to view all the logs that are being generated for a particular instance, select the `guid` of {{site.data.keyword.en_short}} instance from leftnav under subsystems and search the source in serach bar.
